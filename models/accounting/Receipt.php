...
//	public $lob_cd;
    ...
    public function behaviors()
	{
		return [
            ...
            // For receipts generated by Stripe subscriptions, user = system
				['class' => BlameableBehavior::className(), 'defaultValue' => User::USER_SYSTEM],
		];
	}
...
//        return (!is_null($result));
     ...
     * @return OpDate
     */
    protected function getRecdDtObj()
    {
        return (new OpDate)->setFromMySql($this->received_dt);
    }

    protected function setReceivedDefault()
    {
        if (!isset($this->received_dt))
            $this->received_dt = $this->today->getMySqlDate();

...
/* @var $folder String Report project folder */
/* @var $report_nm String */
	...
	$engine->initial_project = $folder;            // Name of report project folder
	$engine->initial_report = $report_nm;           // Name of report to run

...
<div class="site-about">
    ...
    <p><span class="label label-warning">Version </span><span class="label label-primary">0.9.4.321 (Beta 1)</span> Committed to GitHub repository</p>
    <p><span class="label label-warning">Release Date </span><span class="label label-primary">July 9, 2015</span></p>
	    ...
	    <div class="panel panel-warning">
	        ...
	        <div class="panel-body">
		        ...
		        <ul>
		        	<li><span class="label label-primary">New</span> Safari browser does not properly render certain accordions (multipage and show all toggle).</li>

 ...
 */
class RespiratorBrandController extends Controller
{
     ...
     * @param integer $id
     * @return RespiratorBrand the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RespiratorBrand::findOne($id)) !== null) {
            return $model;
        } else {
